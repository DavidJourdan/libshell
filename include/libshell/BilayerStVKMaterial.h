...
{
public:
  BilayerStVKMaterial(double lameAlpha1, double lameBeta1, double lameAlpha2, double lameBeta2)
      : lameAlpha1_(lameAlpha1), lameBeta1_(lameBeta1), lameAlpha2_(lameAlpha2), lameBeta2_(lameBeta2)
  {}
  ...
  virtual double stretchingEnergy(const MeshConnectivity &mesh,
  ...
  virtual double
  bendingEnergy(const MeshConnectivity &mesh,
                const Eigen::MatrixXd &curPos,
