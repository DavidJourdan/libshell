...
enum class RestStateType { RST_NONE, RST_MONOLAYER, RST_BILAYER };
 ...
 * - abars, bbars:  first and second fundamental forms, in the barycentric coordinates of each mesh face, encoding the
 shell rest state. If you have explicit rest geometry, you can compute these using the *FundamentalForms functions.
 Alternatively you can set the forms directly (zero matrices for bbar if you want a flat rest state, for instance).
 */
